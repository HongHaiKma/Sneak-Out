...
public class AdsManagers : Singletons<AdsManagers>
{
    ...
    public void RequestInter()
    {
        ...
        {
            Helper.DebugLog("Request Inter is nullllllllllllll");
        }
        else
        {
            Helper.DebugLog("Request Inter is AAAAAAAAAAAAAAAAAAAAA");
        }
    ...
    //             EventManager.CallEvent(GameEvents.ADS_GOLD_1_ANIM);
    //             break;
    //         case RewardType.GOLD_2:
    //             EventManager.CallEvent(GameEvents.ADS_GOLD_2_ANIM);
    //             break;
    //         case RewardType.CHARACTER_2:
    //             EventManager.CallEvent(GameEvents.ADS_CHARACTER_2_ANIM);
    //             break;
    //     }
    // }
