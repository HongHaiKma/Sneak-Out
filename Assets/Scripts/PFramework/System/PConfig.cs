...
{
    public class PConfig : SingletonScriptableObject<PConfig>
    {
        [Header("App")]
        ...
        [Header("Prefab")]
        [SerializeField] GameObject _objReporter;
        ...
        public static GameObject ObjReporter => Instance._objReporter;
    }
}