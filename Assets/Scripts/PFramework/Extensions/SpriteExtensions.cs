...
namespace PFramework
{
    public static class SpriteExtensions
    {
        ...
        public static Vector3 GetFitScale(this Sprite sprite, float desireWidth, float desireHeight, bool preserveAspect = false)
        {
            return sprite.GetFitScale(new Vector2(desireWidth, desireHeight), preserveAspect);
        }

        public static Vector3 GetFitScale(this Sprite sprite, Vector2 desireSize, bool preserveAspect = false)
        {
            if (preserveAspect)
            {
        ...
        public static void GetUVs(this Sprite sprite, ref Vector2 uv0, ref Vector2 uvSize)
        {
            if (sprite == null)
            {
                Debug.LogError("Can't get uvs, sprite is null");
                return;
            }
