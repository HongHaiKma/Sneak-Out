...
namespace PFramework
{
    public static partial class GameObjectExtensions
    {
        ...
        public static GameObject CreateFitUI(this GameObject prefab, RectTransform parent)
        {
            ...
            rectTransform.offsetMin = parent.offsetMin;
            rectTransform.offsetMax = parent.offsetMax;
            rectTransform.anchorMin = parent.anchorMin;
            rectTransform.anchorMax = parent.anchorMax;
