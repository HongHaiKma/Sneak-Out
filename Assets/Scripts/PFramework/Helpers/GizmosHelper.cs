...
namespace PFramework
{
    ...
    {
        #region Public functions to draw
        ...
        public static void DrawCircleXZ(Vector3 center, float radius, Color? color = null, float angleStep = 10f)
        {
            Draw(color, () => { DrawCircleXZ(center, radius, angleStep); });
        }
        ...
        static void DrawCircleXZ(Vector3 center, float radius, float angleStep = 10f)
        {
            angleStep *= Mathf.Deg2Rad;
